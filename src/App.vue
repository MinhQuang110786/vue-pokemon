...
<div>
    ...
    <result-screen v-if="statusMatch==='result'" :timer="timer" @startAgain="statusMatch='default'" />
    <copy-right-screen />
</div>
</template>
...
import {shuffled} from './utility/array'
export default {
    name: 'App',
    data() {
        return {
    ...
    methods: {
        onHandleBeforeStart(config) {
            console.log('runnning handle before start', config)
